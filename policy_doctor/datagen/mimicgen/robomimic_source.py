...
from policy_doctor.datagen.mimicgen.schema import PolicyRolloutTrajectory, SimulationBackend


@runtime_checkable
class SeedDatasetMaterializer(Protocol):
    """Pluggable writer for a single source demonstration (extend for non-robomimic stacks)."""
