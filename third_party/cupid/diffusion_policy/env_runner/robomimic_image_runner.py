...
class RobomimicImageRunner(BaseImageRunner):
    """
    Rollouts for classic Robomimic / robosuite image datasets (e.g. transport, square).
    Forces ``use_object_obs=False`` on the loaded env to match historical DP defaults.
    """
